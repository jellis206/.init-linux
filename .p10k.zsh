# Generated by Powerlevel10k configuration wizard on 2024-09-16 at 12:25 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_FOLDER_MARKER="first"
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 15 )) && branch[15,-1]="…"  # <-- this line
